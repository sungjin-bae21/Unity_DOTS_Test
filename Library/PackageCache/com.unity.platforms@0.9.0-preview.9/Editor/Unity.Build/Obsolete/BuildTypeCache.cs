...
namespace Unity.Build
{
    ...
    public sealed class BuildTypeCache
    {
        ...
        AssemblyDefinitionAsset[] m_BaseAssemblyAssets = null;
        List<AssemblyDefinition> m_AssemblyList = new List<AssemblyDefinition>();
        ...
        /// <summary>The list of assemblies that are being referenced from this BuildTypeCache</summary>
        ...
        {
            get { return m_BaseAssemblyAssets?.ToArray(); }
            set
            {
                m_BaseAssemblyAssets = value?.ToArray();
                m_IsDirty = true;
            }
        }
        ...
        IEnumerable<AssemblyDefinition> FindMatchingAssemblyDefinitions()
        {
            ...
            if (m_BaseAssemblyAssets == null || m_BaseAssemblyAssets.Length == 0)
            {
